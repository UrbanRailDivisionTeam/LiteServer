...
CREATE TABLE `dm_crrcbi_design_chg_info_df` (
  ...
  `process_creation_date` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `t_bd_material_my` (
  ...
  `FLASTUPDATETIME` timestamp NULL DEFAULT NULL COMMENT 'FLASTUPDATETIME',
  ...
  `CFPROUPTIME` timestamp NULL DEFAULT NULL COMMENT 'CFPROUPTIME',
...
CREATE TABLE `t_bd_measureunit_my_copy1` (
  ...
  `FCREATETIME` timestamp NULL DEFAULT NULL COMMENT 'FCREATETIME',
...
CREATE TABLE `dm_abnormal3_data` (
  ...
  `p_create_date` timestamp NULL DEFAULT NULL COMMENT 'p_create_date',
  `p_modify_date` timestamp NULL DEFAULT NULL COMMENT 'p_modify_date',
  `p_response_id` varchar(500) COLLATE utf8_bin DEFAULT NULL COMMENT 'p_response_id',
  `p_response_date` timestamp NULL DEFAULT NULL COMMENT 'p_response_date',
  `p_handl_id` varchar(500) COLLATE utf8_bin DEFAULT NULL COMMENT 'p_handl_id',
  `p_handl_date` timestamp NULL DEFAULT NULL COMMENT 'p_handl_date',
  `p_close_id` varchar(500) COLLATE utf8_bin DEFAULT NULL COMMENT 'p_close_id',
  `p_close_date` timestamp NULL DEFAULT NULL COMMENT 'p_close_date',
...
CREATE TABLE `dm_commissioning_task` (
  ...
  `mysql_plannedFinishTime` timestamp NULL DEFAULT NULL COMMENT 'mysql_plannedFinishTime',
...
CREATE TABLE `dm_ct_con_contract` (
  ...
  `FLASTUPDATETIME` timestamp NULL DEFAULT NULL COMMENT '最后修改时间',
  `FNUMBER` varchar(120) COLLATE utf8_bin DEFAULT NULL COMMENT '单据编码',
  `FBIZDATE` timestamp NULL DEFAULT NULL COMMENT '业务日期',
  ...
  `CFEFFECTIVEDATE` timestamp NULL DEFAULT NULL COMMENT '生效时间',
  ...
  `CFAUDITORTIME` timestamp NULL DEFAULT NULL COMMENT '审核时间',
...
CREATE TABLE `dm_eas_approvaltimeout` (
  ...
  `ftime` timestamp NULL DEFAULT NULL COMMENT '节点分配时间',
...
CREATE TABLE `dm_eas_approvaltimeoutld` (
  ...
  `FCreateTime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '到达节点时间',
  `ftime` timestamp NULL DEFAULT NULL COMMENT '到达节点时间',
...
CREATE TABLE `dm_eas_busi_approve_overdue_bill_detial` (
  ...
  `fcomletetime` timestamp NULL DEFAULT NULL COMMENT 'fcomletetime',
...
CREATE TABLE `dm_eas_ct_zjb_designbombill` (
  ...
  `FBIZDATE` timestamp NULL DEFAULT NULL COMMENT 'FBIZDATE',
  ...
  `CFDESIGNDATE` timestamp NULL DEFAULT NULL COMMENT 'CFDESIGNDATE',
  ...
  `CFAUDITDATE` timestamp NULL DEFAULT NULL COMMENT 'CFAUDITDATE',
  ...
  `CFFLOWDATE` timestamp NULL DEFAULT NULL COMMENT 'CFFLOWDATE',
...
CREATE TABLE `dm_eas_notscanbillall` (
  ...
  `backdate` timestamp NULL DEFAULT NULL COMMENT '单据退回时间',
  `companynumber` varchar(100) COLLATE utf8_bin DEFAULT NULL COMMENT '公司编码',
  `appliernumber` varchar(100) COLLATE utf8_bin DEFAULT NULL COMMENT '申请人编码',
  `deptnumber` varchar(100) COLLATE utf8_bin DEFAULT NULL COMMENT '申请部门编码',
  `submitdatecopy` timestamp NULL DEFAULT NULL COMMENT '单据提交时间2',
  `backdatecopy` timestamp NULL DEFAULT NULL COMMENT '单据退回时间2',
  `startbizdate` date DEFAULT NULL COMMENT '开始业务时间',
  `endbizdate` date DEFAULT NULL COMMENT '结束业务时间'
...
CREATE TABLE `dm_eas_payment_detail_reimbursement_number` (
  ...
  `logtime` timestamp NULL DEFAULT NULL COMMENT 'logtime',
...
CREATE TABLE `dm_eas_pms_sjzttest11` (
  ...
  `FPLANENDTIME` timestamp NULL DEFAULT NULL COMMENT '计划完工时间',
  `FEARISTBEGINTIME` timestamp NULL DEFAULT NULL COMMENT '最早开工时间',
  `FLASTBEGINTIME` timestamp NULL DEFAULT NULL COMMENT '最晚开工时间',
  `FEARISTENDTIME` timestamp NULL DEFAULT NULL COMMENT '最早完工时间',
  `FLASTENDTIME` timestamp NULL DEFAULT NULL COMMENT '最晚完工时间',
  ...
  `FACTUALBEGINTIME` timestamp NULL DEFAULT NULL COMMENT '实际开工时间',
  `FACTUALENDTIME` timestamp NULL DEFAULT NULL COMMENT '实际完工时间',
  ...
  `FAUDITTIME` timestamp NULL DEFAULT NULL COMMENT '审核日期',
  ...
  `FCREATETIME` timestamp NULL DEFAULT NULL COMMENT '创建时间',
  ...
  `CFNODATE` timestamp NULL DEFAULT NULL COMMENT 'NCR编号记录日期',
  ...
  `FREQENDTIME` timestamp NULL DEFAULT NULL COMMENT '需求完工时间',
  ...
  `BID_DATE` timestamp NULL DEFAULT NULL COMMENT '投标日期',
  ...
  `FIRST_DELIV_DATE` timestamp NULL DEFAULT NULL COMMENT '首列时间',
  `LAST_DELIV_DATE` timestamp NULL DEFAULT NULL COMMENT '末列时间',
...
CREATE TABLE `dm_eas_returned_bill_detail` (
  ...
  `fendtime` timestamp NULL DEFAULT NULL COMMENT '结束退回时间',
  ...
  `fcomletetime` timestamp NULL DEFAULT NULL COMMENT 'fcomletetime',
  `fendcomletetime` timestamp NULL DEFAULT NULL COMMENT 'fendcomletetime',
...
CREATE TABLE `dm_eas_returned_unsubmitted_documents` (
  ...
  `endttime` timestamp NULL DEFAULT NULL COMMENT '退回时间end',
...
CREATE TABLE `dm_eas_share_bill_statistic_reimbursed` (
  ...
  `fenddate` timestamp NULL DEFAULT NULL COMMENT 'fenddate'
...
CREATE TABLE `dm_eas_shared_second_review_return_statistics` (
  ...
  `endtime` timestamp NULL DEFAULT NULL COMMENT 'endtime'
...
CREATE TABLE `dm_eas_t_bc_evectionreqbill` (
  ...
  `FBIZREQDATE` timestamp NULL DEFAULT NULL COMMENT 'FBIZREQDATE',
  ...
  `FAUDITDATE` timestamp NULL DEFAULT NULL COMMENT 'FAUDITDATE',
  `FBILLDATE` timestamp NULL DEFAULT NULL COMMENT 'FBILLDATE',
...
CREATE TABLE `dm_eas_t_bd_person` (
  ...
  `FZDY9` timestamp NULL DEFAULT NULL COMMENT 'FZDY9',
  `FZDY10` timestamp NULL DEFAULT NULL COMMENT 'FZDY10',
  `FZDY11` timestamp NULL DEFAULT NULL COMMENT 'FZDY11',
  `FZDY12` timestamp NULL DEFAULT NULL COMMENT 'FZDY12',
  `FZDY13` timestamp NULL DEFAULT NULL COMMENT 'FZDY13',
  `FZDY14` timestamp NULL DEFAULT NULL COMMENT 'FZDY14',
  ...
  `FBRANCHTIME` timestamp NULL DEFAULT NULL COMMENT 'FBRANCHTIME',
  ...
  `FPOSTTIME` timestamp NULL DEFAULT NULL COMMENT 'FPOSTTIME',
  `FENROLLMENTTIME` timestamp NULL DEFAULT NULL COMMENT 'FENROLLMENTTIME',
  `FHICKTIME` timestamp NULL DEFAULT NULL COMMENT 'FHICKTIME',
  `FRETURNTIME` timestamp NULL DEFAULT NULL COMMENT 'FRETURNTIME',
  `FRETIRETIME` timestamp NULL DEFAULT NULL COMMENT 'FRETIRETIME',
  ...
  `FCOMEFUGLETIME` timestamp NULL DEFAULT NULL COMMENT 'FCOMEFUGLETIME',
  ...
  `CFFPOSTTIME` timestamp NULL DEFAULT NULL COMMENT 'CFFPOSTTIME',
  ...
  `CFFBRANCHTIME` timestamp NULL DEFAULT NULL COMMENT 'CFFBRANCHTIME',
  ...
  `CFFCOMEFUGLETIME` timestamp NULL DEFAULT NULL COMMENT 'CFFCOMEFUGLETIME',
  ...
  `CFFRETIRETIME` timestamp NULL DEFAULT NULL COMMENT 'CFFRETIRETIME',
  `CFFBRANCHCODE` varchar(384) COLLATE utf8_bin DEFAULT NULL COMMENT 'CFFBRANCHCODE',
  `CFFENROLLMENTTIME` timestamp NULL DEFAULT NULL COMMENT 'CFFENROLLMENTTIME',
  ...
  `CFFRETURNTIME` timestamp NULL DEFAULT NULL COMMENT 'CFFRETURNTIME',
  `CFFHICKTIME` timestamp NULL DEFAULT NULL COMMENT 'CFFHICKTIME',
  ...
  `CFFLDATE` timestamp NULL DEFAULT NULL COMMENT 'CFFLDATE',
  ...
  `FCLOUDUPDATETIME` timestamp NULL DEFAULT NULL COMMENT 'FCLOUDUPDATETIME',
...
CREATE TABLE `dm_eas_t_im_inventory` (
  ...
  `CFBIZDATE` timestamp NULL DEFAULT NULL COMMENT 'CFBIZDATE',
  ...
  `CFUPDATETIME` timestamp NULL DEFAULT NULL COMMENT 'CFUPDATETIME',
...
CREATE TABLE `dm_eas_t_im_purinwarehsbill` (
  ...
  `FAUDITTIME` timestamp NULL DEFAULT NULL COMMENT 'FAUDITTIME',
  ...
  `FMODIFICATIONTIME` timestamp NULL DEFAULT NULL COMMENT 'FMODIFICATIONTIME',
...
CREATE TABLE `dm_eas_t_mm_project` (
  ...
  `FPLANENDTIME` timestamp NULL DEFAULT NULL COMMENT 'FPLANENDTIME',
  `FEARISTBEGINTIME` timestamp NULL DEFAULT NULL COMMENT 'FEARISTBEGINTIME',
  `FLASTBEGINTIME` timestamp NULL DEFAULT NULL COMMENT 'FLASTBEGINTIME',
  `FEARISTENDTIME` timestamp NULL DEFAULT NULL COMMENT 'FEARISTENDTIME',
  `FLASTENDTIME` timestamp NULL DEFAULT NULL COMMENT 'FLASTENDTIME',
  ...
  `FACTUALBEGINTIME` timestamp NULL DEFAULT NULL COMMENT 'FACTUALBEGINTIME',
  `FACTUALENDTIME` timestamp NULL DEFAULT NULL COMMENT 'FACTUALENDTIME',
  ...
  `CFNODATE` timestamp NULL DEFAULT NULL COMMENT 'CFNODATE',
  ...
  `FREQENDTIME` timestamp NULL DEFAULT NULL COMMENT 'FREQENDTIME',
  ...
  `FREQBEGINTIME` timestamp NULL DEFAULT NULL COMMENT 'FREQBEGINTIME',
...
CREATE TABLE `dm_eas_t_pm_user` (
  ...
  `FINVALIDATIONDATE` timestamp NULL DEFAULT NULL COMMENT 'FINVALIDATIONDATE',
  ...
  `FPWEFFECTIVEDATE` timestamp NULL DEFAULT NULL COMMENT 'FPWEFFECTIVEDATE',
  `FLOCKEDTIME` timestamp NULL DEFAULT NULL COMMENT 'FLOCKEDTIME',
  ...
  `FUNAUTHORTIME` timestamp NULL DEFAULT NULL COMMENT 'FUNAUTHORTIME',
...
CREATE TABLE `dm_eas_uncommitted` (
  ...
  `ftasktimes` timestamp NULL DEFAULT NULL COMMENT '单据退回时间',
  `fstoptime` longtext COLLATE utf8_bin COMMENT '节点停留时间',
  `fcompanynumber` longtext COLLATE utf8_bin COMMENT '公司编码',
  `fnamenumber` longtext COLLATE utf8_bin COMMENT '申请人编码',
  `fdptnumber` longtext COLLATE utf8_bin COMMENT '申请部门编码',
  `fsaveendtime` timestamp NULL DEFAULT NULL COMMENT '单据保存时间结束',
  `fendtasktimes` timestamp NULL DEFAULT NULL COMMENT '单据退回时间',
  `fbizdate` timestamp NULL DEFAULT NULL COMMENT '开始业务日期',
  `fbizdateld` timestamp NULL DEFAULT NULL COMMENT '结束业务日期'
...
CREATE TABLE `dm_t_gx_yfhtkp` (
  ...
  `CFSIGNDATE` timestamp NULL DEFAULT NULL COMMENT '合同签订日期',
  `CFHTJE` double(28,0) DEFAULT NULL COMMENT '合同金额',
  `CFADULTTIME` timestamp NULL DEFAULT NULL COMMENT '审核时间',
...
CREATE TABLE `dm_t_org_admin` (
  ...
  `FINVALIDDATE` timestamp NULL DEFAULT NULL COMMENT 'FINVALIDDATE',
  ...
  `FPROPERTYSEALUPDATE` timestamp NULL DEFAULT NULL COMMENT 'FPROPERTYSEALUPDATE',
  ...
  `FSETUPDATE` timestamp NULL DEFAULT NULL COMMENT 'FSETUPDATE',
  `FENDUPDATE` timestamp NULL DEFAULT NULL COMMENT 'FENDUPDATE',
...
CREATE TABLE `lt_im_materialreqbillentry` (
  ...
  `FEXP` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'FEXP',
  `FMFG` timestamp NULL DEFAULT NULL COMMENT 'FMFG',
  ...
  `FPICKINGDATE` timestamp NULL DEFAULT NULL COMMENT 'FPICKINGDATE',
  `FDEMANDDATE` timestamp NULL DEFAULT NULL COMMENT 'FDEMANDDATE',
...
CREATE TABLE `ods_eas_t_ap_payrequestbill` (
  ...
  `CFFPTJRQ` timestamp NULL DEFAULT NULL COMMENT 'CFFPTJRQ',
  ...
  `CFBEGINPAYDATE` timestamp NULL DEFAULT NULL COMMENT 'CFBEGINPAYDATE',
  `CFENDPAYDATE` timestamp NULL DEFAULT NULL COMMENT 'CFENDPAYDATE',
...
CREATE TABLE `ods_eas_t_cas_paymentbill` (
  ...
  `FADMINORGUNITID` varchar(44) COLLATE utf8_bin DEFAULT NULL COMMENT 'FADMINORGUNITID',
  `FPERSONID` varchar(44) COLLATE utf8_bin DEFAULT NULL COMMENT 'FPERSONID',
  `FPAYDATE` timestamp NULL DEFAULT NULL COMMENT 'FPAYDATE',
  ...
  `FAPPROVEDATE` timestamp NULL DEFAULT NULL COMMENT 'FAPPROVEDATE',
  ...
  `FACCEPTERDATE` timestamp NULL DEFAULT NULL COMMENT 'FACCEPTERDATE',
  ...
  `FBILLDATE_SOURCEBILL` timestamp NULL DEFAULT NULL COMMENT 'FBILLDATE_SOURCEBILL',
  ...
  `FSUBSETTDATE` timestamp NULL DEFAULT NULL COMMENT 'FSUBSETTDATE',
  ...
  `FCOMMITBETIME` timestamp NULL DEFAULT NULL COMMENT 'FCOMMITBETIME',
  `FSETTLEFEETYPE` int(11) DEFAULT NULL COMMENT 'FSETTLEFEETYPE',
  `FEXPECTDEALTIME` timestamp NULL DEFAULT NULL COMMENT 'FEXPECTDEALTIME',
  ...
  `FTRADEDTIME` timestamp NULL DEFAULT NULL COMMENT 'FTRADEDTIME',
  `CFSYNSTATUS` varchar(100) COLLATE utf8_bin DEFAULT NULL COMMENT 'CFSYNSTATUS',
...
CREATE TABLE `t_ap_otherbill` (
  ...
  `CFINVOICEACTUALDATE` timestamp NULL DEFAULT NULL COMMENT 'CFINVOICEACTUALDATE',
...
CREATE TABLE `t_ap_otherbillentry` (
  ...
  `FPAYABLEDATE` timestamp NULL DEFAULT NULL COMMENT 'FPAYABLEDATE',
...
CREATE TABLE `t_im_materialreqbill` (
  ...
  `CFSTARTDIRDATE` timestamp NULL DEFAULT NULL COMMENT 'CFSTARTDIRDATE',
  `CFENDDIRERID` varchar(44) COLLATE utf8_bin DEFAULT NULL COMMENT 'CFENDDIRERID',
  `CFENDDIRDATE` timestamp NULL DEFAULT NULL COMMENT 'CFENDDIRDATE',
  `CFGOOUTERID` varchar(44) COLLATE utf8_bin DEFAULT NULL COMMENT 'CFGOOUTERID',
  `CFGOOUTDATE` timestamp NULL DEFAULT NULL COMMENT 'CFGOOUTDATE',
  `CFALLINKID` varchar(75) COLLATE utf8_bin DEFAULT NULL COMMENT 'CFALLINKID',
  ...
  `CFWASTEDATE` timestamp NULL DEFAULT NULL COMMENT 'CFWASTEDATE',
...
CREATE TABLE `t_im_purinwarehsentry` (
  ...
  `FEXP` timestamp NULL DEFAULT NULL COMMENT 'FEXP',
  ...
  `FENTREFACTORYDATE` timestamp NULL DEFAULT NULL COMMENT 'FENTREFACTORYDATE',
...
CREATE TABLE `wms_asn` (
  ...
  `START_RECEIVED_DATE` timestamp NULL DEFAULT NULL COMMENT 'START_RECEIVED_DATE',
  `END_RECEIVED_DATE` timestamp NULL DEFAULT NULL COMMENT 'END_RECEIVED_DATE',
  ...
  `INTERFACE_DATE` timestamp NULL DEFAULT NULL COMMENT 'INTERFACE_DATE',
  ...
  `LASTCHECKDATE` timestamp NULL DEFAULT NULL COMMENT 'LASTCHECKDATE',
  ...
  `LASTRECEIVEDATE` timestamp NULL DEFAULT NULL COMMENT 'LASTRECEIVEDATE',
  `LAST_UPDATER` varchar(200) COLLATE utf8_bin DEFAULT NULL COMMENT 'LAST_UPDATER',
  `LAST_UPDATETIME` timestamp NULL DEFAULT NULL COMMENT 'LAST_UPDATETIME',
  ...
  `SHIP_NEED_DATE` timestamp NULL DEFAULT NULL COMMENT 'SHIP_NEED_DATE',
...
CREATE TABLE `dm_problem_detail` (
  ...
  `f_completedate` timestamp NULL DEFAULT NULL COMMENT '完成日期',
